...
namespace Server.DAL
{
    ...
    public class TransactionDAL : ITransactionDAL
    {
        ...
        public async Task<ResultSqlActionData<List<TransactionActionBasic>>> TransactionActionUpdate(TransactionActionBasic transactionActionBasic)
        {
            SqlParameter[] sqlParameters = new SqlParameter[4];
            sqlParameters[0] = new SqlParameter("@TransactionActionID", transactionActionBasic.ID);
            sqlParameters[1] = new SqlParameter("@NewAmount", transactionActionBasic.Amount);
            sqlParameters[2] = new SqlParameter("@NewBankAccountNumber", transactionActionBasic.BankAccountNumber);
            sqlParameters[3] = new SqlParameter("@NewUpdateAt", transactionActionBasic.UpdatedAt);
